...
public class Denicker {
    ...
    public void onTick(TickEvent.ClientTickEvent event) {
        ...
        if (awaitingLocraw) {
            ...
            if (locrawTimeout > 100) {
                ...
                locrawTimeout = 0;
                pendingProfile = null;
                System.out.println("[S] Error: /locraw timeout.");
            }
        }
    ...
    private void processStats(String profileName) {
        ...
        switch (gameType) {
            case "BEDWARS":
                BwListStats.listBedwarsStats(Arrays.asList(profileName));
                break;
            case "DUELS":
    ...
    HashSet<String> nicks = new HashSet<>(
            Arrays.asList("4c7b0468044bfecacc43d00a3a69335a834b73937688292c20d3988cae58248d",
