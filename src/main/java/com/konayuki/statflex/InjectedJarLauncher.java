...
final class InjectedJarLauncher {
    private static final String MAIN_CLASS = "com.konayuki.statflex.Main";
    private static final String INIT_METHOD = "init";

    private InjectedJarLauncher() {
    }
    ...
    private static ClassLoader findMinecraftClassLoader(ClassLoader preferredLoader) {
        ...
        addCandidate(candidates, InjectedJarLauncher.class.getClassLoader());
