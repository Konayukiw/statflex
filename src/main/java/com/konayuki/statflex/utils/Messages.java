...
public final class Messages {
    public static final String PREFIX =
            Color.DARK_GRAY + "[" + Color.RED + "S" + Color.DARK_GRAY + "]" + Color.GRAY + " ";
    ...
    public static final String INVALID_API = PREFIX + "API Key is invalid or not set. /s api "
            + Color.YELLOW + "[API Key]" + Color.GRAY + " to set.";
    ...
    public static final String BEDWARS_STATS = PREFIX + Color.RED + Color.BOLD + "Bed"
            + Color.WHITE + Color.BOLD + "Wars " + Color.GRAY + "stats | ";
    public static final String DUELS_STATS = PREFIX + Color.AQUA + Color.BOLD + "Duels "
            + Color.GRAY + "| ";
    public static final String SKYWARS_STATS = PREFIX + Color.AQUA + Color.BOLD + "Sky"
            + Color.YELLOW + Color.BOLD + "Wars " + Color.GRAY + "| ";
