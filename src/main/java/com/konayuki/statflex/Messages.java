...
public class Messages {
    ...
    public static final String API_INVALID = PREFIX + "API Key is invalid or not set. Use /s api [API Key] to set.";
    public static final String PLAYER_NOT_FOUND = PREFIX + "Player not found or stats unavailable.";
    public static final String FRESH_STATS = PREFIX + "§4Fresh stats";
