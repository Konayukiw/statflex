...
public final class MappingBridge {
    ...
    private static void load() {
        InputStream in = MappingBridge.class.getResourceAsStream("/resolutions/mappings.json");
        if (in == null) {
            FAILURES.add("mappings.json missing from the jar");
            return;
        }
        try {
            ...
            FAILURES.add("mappings.json unreadable: " + t);
        }
    }
