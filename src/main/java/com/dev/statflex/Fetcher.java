    ...
    public void processCommand(ICommandSender sender, String[] args) {
        ...
        switch (args[0].toLowerCase()) {
            ...
            case "help":
                ...
                sendChat("§c || §7/s api §b[API Key] §8: §7Set your Hypixel API key");
                sendChat("§c || §c- §7You must get API Key from §ehttps://developer.hypixel.net");
                sendChat("§c || §7/s bw §e[Player] -[Mode] §8: §7Get Bedwars stats");
                sendChat("§c || §7/s sw §e[Player] -[Mode] §8: §7Get Skywars stats");
                sendChat("§c || §7/s duels §e[Player] -[Mode] §8: §7Get Duels stats");
                sendChat("§c || §7/s nh §e[Player] §8: §7Get Name History for the player");
                sendChat("§c || §7/s autogg §8: §7Show current AutoGG messages");
                sendChat("§c || §7/s autogg §e[Message] §8: §7Add message for AutoGG");
                sendChat("§c || §7/s list §8: §7Toggle stats list can be shown by /who");
                sendChat("§c || §7/s auto §8: §7Toggle Duels Auto-Stats for each games");
                sendChat("§c || §7/s denick §8: §7Toggle Auto-Denick every time");
                sendChat("§c || §7/s keepwho §8: §7Keep original /who message visible in Bedwars");
                sendChat("§c || §7/s settings §8: §7Open togglable settings");
                sendChat("§c || §7/s secure §8: §7Toggle secure connection");
                sendChat("§c || §c- §7This may help solving Name History error");
                sendChat("§c || §c- §7Recommend to have secure connection enabled unless for errors");
                sendChat(" ");
                sendChat("§c || §7/s help §8: §7Open help");
